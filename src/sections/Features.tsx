  ...
  return (
    <section className="py-20 md:py-24">
      <div className="container">
        ...
        bg-[radial-gradient(100%_100%_at_top_left,white,white,rgb(91,51,185,0.9))] text-transparent bg-clip-text"
        >
          Elevate your SEO efforts.
        </h2>
        <p className="text-white/70 text-lg md:text-xl max-w-xl mx-auto tracking-tighter text-center mt-5">
          From small startups to large enterprises, discover the power of our
